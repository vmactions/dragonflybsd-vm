...
You can use [AnyVM](https://github.com/anyvm-org/anyvm) to run the DragonflyBSD VM locally for debugging. It's the same environment as in the GitHub Actions.
